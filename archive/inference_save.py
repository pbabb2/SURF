...
def video_inf(interpreter, anchors, classes, model_path, threshold=0.25):
    cap = cv2.VideoCapture(model_path)
    
    #vid_cod = cv2.VideoWriter_fourcc(*'XVID')
    #out = cv2.VideoWriter("/home/pi/edge-tpu-tiny-yolo/filename.avi", vid_cod, 20.0, (640,480))
    #fourcc = cv2.VideoWriter_fourcc(*'XVID') 
    #out = cv2.VideoWriter('output.avi', fourcc, 20.0, (640, 480))
    fourcc = cv2.VideoWriter_fourcc(*'XVID')
    out = cv2.VideoWriter('output23.avi', fourcc, 20.0, (640, 480))
